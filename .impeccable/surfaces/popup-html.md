...
“The Memory Counter”: a compact monochrome video-deck control surface with a dominant tabular timecode, matte black chassis, inset display, literal controls, and one white signal lamp. The memorable moment is seeing the local checkpoint as a physical-feeling time counter rather than an abstract settings row.
